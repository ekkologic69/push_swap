...
NAME = push_swap
BONUS = checker
SRCS = push_swap.c push_swap_utils.c push_swap_utils2.c operations.c operations2.c small_sort.c check_args.c ft_atoi.c index.c  big_sort.c push_swap_utils3.c sort.c mid_sort.c sort_100.c
